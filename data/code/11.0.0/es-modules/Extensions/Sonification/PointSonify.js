...
(function (PointSonify) {
    ...
    function pointSonify(options) {
        const point = this, chart = point.series.chart, masterVolume = pick(options.masterVolume, chart.options.sonification &&
        ...
        getMappingValue = function (value, makeFunction, allowedExtremes) {
            ...
            if (typeof value === 'string') {
                ...
                const dataProp = hasInvertedPolarity ?
                    value.slice(1) : value;
                const pointValue = pick(point[dataProp], point.options[dataProp]);
    ...
    function pointCancelSonify(fadeOut) {
        const playing = (this.sonification && this.sonification.instrumentsPlaying), instrIds = playing && Object.keys(playing);
