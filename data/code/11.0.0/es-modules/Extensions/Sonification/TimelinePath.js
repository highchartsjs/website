...
class TimelinePath {
     ...
     */
    playEvents(direction) {
        const timelinePath = this, curEvent = timelinePath.events[this.cursor], nextEvent = timelinePath.events[this.cursor + direction], onEnd = function (signalData) {
