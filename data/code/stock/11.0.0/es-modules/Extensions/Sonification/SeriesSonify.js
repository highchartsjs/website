...
(function (SeriesSonify) {
    ...
    function buildChartSonifySeriesOptions(series, dataExtremes, chartSonifyOptions) {
        const additionalSeriesOptions = chartSonifyOptions.seriesOptions || {}, sonification = series.chart.options.sonification, pointPlayTime = (sonification &&
    ...
    function buildTimelinePathFromSeries(series, options) {
        ...
        timelineEvents = series.points.reduce(function (events, point) {
            const earcons = getPointEarcons(point, options.earcons || []), time = pointToTime(point);
    ...
    function getFinalNoteDuration(series, instruments, dataExtremes) {
        ...
        return instruments.reduce((duration, instrument) => {
    ...
    function getSeriesInstrumentOptions(series, options) {
        ...
        const defaultInstrOpts = (series.chart.options.sonification &&
        ...
        // default options
        return (seriesInstrOpts).map((optionSet) => {
    ...
    function getSeriesSonifyOptions(series, options) {
        const chartOpts = series.chart.options.sonification, seriesOpts = series.options.sonification;
        return merge({
    ...
    function makeInstrumentCopies(instruments) {
        return instruments.map(function (instrumentDef) {
            const instrument = instrumentDef.instrument, copy = (typeof instrument === 'string' ?
    ...
    function sonify(options) {
        const mergedOptions = getSeriesSonifyOptions(this, options), timelinePath = buildTimelinePathFromSeries(this, mergedOptions), chartSonification = this.chart.sonification;
